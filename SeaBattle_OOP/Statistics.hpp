...
private:
	int num_all_; // Всего кораблей
	int num_1_; // Кол-во одно-клеточных кораблей
	int num_2_; // Кол-во двух-клеточных кораблей
	int num_3_; // Кол-во трёх-клеточных кораблей
	int num_4_; // Кол-во четырёх-клеточных кораблей
